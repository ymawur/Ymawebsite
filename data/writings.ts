...
const rawBase = 'https://raw.githubusercontent.com/ymawur/Ymawebsite/main/app/writings'
...
export const writings: Writing[] = [
  {
    ...
    sections: [
      {
        ...
        title: 'Structure as the central relation connecting food production and consumption',
        body: [
    ...
    footer: ['This reflection was inspired by the S-PRO2 model outlined by Erich Windhab for food processing and structure.'],
  },
  {
        ...
        subsections: [
          {
            label: '01',
            title: 'Discover',
            body: ['Fundamental principles explain how a system behaves and identify mechanisms that could support new functions. This is science.'],
          },
          {
            label: '02',
            title: 'Develop',
            body: ['Engineering converts scientific theories and understanding into instruments, processes, models, or materials that operate and interact.'],
          },
          {
            label: '03',
            title: 'Optimize and scale',
            body: ['Optimization improves efficiency, while scaling makes volume effects visible across conditions, sources, and application contexts.'],
          },
          {
            label: '04',
            title: 'Enable',
            body: ['The resulting capacity supports new science, while optimized and scaled development creates routes toward industrial, economic, and broader societal value.'],
          },
        ],
      },
      {
        ...
        subsections: [
          {
            ...
            body: ['Measurements should represent food properties in ways that agree with human sensory perception and remain useful for engineering decisions.'],
          },
          {
            label: 'Optimization',
            title: 'Scaling out messy experiments',
            body: ['Food experiments involve variable materials and complex responses, requiring higher throughput without removing scientifically meaningful sources of variation.'],
          },
          {
            label: 'Scaling',
            title: 'Extending the search space',
            body: ['Improved throughput expands the formulations and processing conditions that can be explored, creating opportunities for unexpected and transferable insights.'],
          },
          {
            label: 'Optimization',
            title: 'Making predictive models generalize',
            body: ['Cross-source generalization determines whether predictive food models retain useful performance across ingredients, instruments, laboratories, and datasets.'],
          },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        subsections: [
          { title: 'Discover', body: ['The discover phase seeks to understand the problem through engagement with people and processes that are directly affected by the issue.'] },
          { title: 'Define', body: ['Insights gathered during discovery support the definition of a specific research challenge that can be examined from a new perspective.'] },
          { title: 'Develop', body: ['A clearly defined challenge may support several solutions, which can be developed collaboratively by engaging experts with complementary perspectives.'] },
          { title: 'Deliver', body: ['Potential solutions are validated before the best-performing approach is packaged and delivered to the users who need it most.'] },
        ],
      },
      {
        ...
        callout: 'This shortened diamond hides the upstream work of discovering a worthwhile topic and defining the right research question.',
      },
      {
        ...
        callout: 'Without explicit convergence, a project can continue expanding while the central research question and resulting thesis remain insufficiently resolved.',
      },
      {
    ...
    footer: ['This page draws substantial inspiration from the Design Council’s Framework for Innovation and its Double Diamond model.'],
  },
]
